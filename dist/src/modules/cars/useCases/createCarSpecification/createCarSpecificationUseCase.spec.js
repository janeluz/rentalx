...
describe('create Car Specification', function () {
    beforeEach(function () {
        ...
        createCarSpecificationUseCase = new createCarSpecificationUseCase_1.CreateCarSpecificationUseCase(carsRepositoryInMemory);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    car_id = '1234';
                    specifications_id = ['54321'];
                    return [4 /*yield*/, createCarSpecificationUseCase.execute({ car_id: car_id, specifications_id: specifications_id })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
