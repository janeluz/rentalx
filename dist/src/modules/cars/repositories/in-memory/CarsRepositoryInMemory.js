...
var CarsRepositoryInMemory = /** @class */ (function () {
    ...
    CarsRepositoryInMemory.prototype.create = function (_a) {
        var brand = _a.brand, category_id = _a.category_id, name = _a.name, description = _a.description, daily_rate = _a.daily_rate, fine_amount = _a.fine_amount, license_plate = _a.license_plate;
