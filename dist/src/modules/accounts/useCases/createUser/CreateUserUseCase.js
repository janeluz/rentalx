...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.excute = function (_a) {
        var name = _a.name, email = _a.email, isAdmin = _a.isAdmin, password = _a.password, driver_license = _a.driver_license;
