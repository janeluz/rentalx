...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, isAdmin, password, driver_license, createUserUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, isAdmin = _a.isAdmin, password = _a.password, driver_license = _a.driver_license;
                        createUserUseCase = tsyringe_1.container.resolve(CreateUserUseCase_1.CreateUserUseCase);
                        return [4 /*yield*/, createUserUseCase.excute({
                                name: name,
                                email: email,
                                isAdmin: isAdmin,
                                password: password,
